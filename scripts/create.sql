...
(
    ...
    BONUSES        INTEGER      CHECK (BONUSES > 0) DEFAULT 0 NOT NULL
);
...
(
    ...
    DESCRIPTION TEXT,
    OWNER       INTEGER      REFERENCES USERS (ID) ON UPDATE CASCADE ON DELETE CASCADE NOT NULL
);
